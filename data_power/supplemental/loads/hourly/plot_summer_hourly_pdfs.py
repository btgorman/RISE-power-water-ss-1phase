...
load_data_low = np.genfromtxt("data/load_summer_hourly_data_low.txt")
load_data_high = np.genfromtxt("data/load_summer_hourly_data_high.txt")
x = np.arange(50., 110.)
...
norm_mu = 93.7931
norm_sigma = 3.97734
plt.plot(x, normal(x, norm_mu, norm_sigma) * sumcount_high, color="teal", label="normal, AIC 166.84")
...
lev_mu = 62.529
lev_sigma = 5.90733
plt.plot(x, lev(x, lev_mu, lev_sigma) * sumcount_low, color="red", label="lev, AIC 132.57")
...
plt.title("Summer", fontsize="x-large")
