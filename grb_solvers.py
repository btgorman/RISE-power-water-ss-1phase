...
def contingency_response(object_load, object_generator, object_cable, losses, exports):
	...
	try:
		...
		m.addConstr(r_101 >= uc_101 * (3*NUMBER_OF_MINUTES * -r_g[101]))
		m.addConstr(r_201 >= uc_201 * (3*NUMBER_OF_MINUTES * -r_g[201]))
		m.addConstr(r_301 >= uc_g[301] * (3*NUMBER_OF_MINUTES * -r_g[301]))
		m.addConstr(r_401 >= uc_g[401] * (3*NUMBER_OF_MINUTES * -r_g[401]))
		m.addConstr(r_102 >= uc_102 * (3*NUMBER_OF_MINUTES * -r_g[102]))
		m.addConstr(r_202 >= uc_202 * (3*NUMBER_OF_MINUTES * -r_g[202]))
		m.addConstr(r_302 >= uc_g[302] * (3*NUMBER_OF_MINUTES * -r_g[302]))
		m.addConstr(r_402 >= uc_g[402] * (3*NUMBER_OF_MINUTES * -r_g[402]))
		m.addConstr(r_107 >= uc_g[107] * (NUMBER_OF_MINUTES * -r_g[107]))
		m.addConstr(r_207 >= uc_g[207] * (3*NUMBER_OF_MINUTES * -r_g[207]))
		m.addConstr(r_307 >= uc_g[307] * (3*NUMBER_OF_MINUTES * -r_g[307]))
		m.addConstr(r_113 >= uc_g[113] * (3*NUMBER_OF_MINUTES * -r_g[113]))
		m.addConstr(r_213 >= uc_g[213] * (3*NUMBER_OF_MINUTES * -r_g[213]))
		m.addConstr(r_313 >= uc_g[313] * (3*NUMBER_OF_MINUTES * -r_g[313]))
		m.addConstr(r_115 >= uc_g[115] * (3*NUMBER_OF_MINUTES * -r_g[115]))
		m.addConstr(r_215 >= uc_g[215] * (3*NUMBER_OF_MINUTES * -r_g[215]))
		m.addConstr(r_315 >= uc_g[315] * (3*NUMBER_OF_MINUTES * -r_g[315]))
		m.addConstr(r_415 >= uc_g[415] * (3*NUMBER_OF_MINUTES * -r_g[415]))
		m.addConstr(r_515 >= uc_g[515] * (3*NUMBER_OF_MINUTES * -r_g[515]))
		m.addConstr(r_615 >= uc_g[615] * (3*NUMBER_OF_MINUTES * -r_g[615]))
		m.addConstr(r_116 >= uc_g[116] * (3*NUMBER_OF_MINUTES * -r_g[116]))
		m.addConstr(r_118 >= uc_g[118] * (3*NUMBER_OF_MINUTES * -r_g[118]))
		m.addConstr(r_121 >= uc_g[121] * (3*NUMBER_OF_MINUTES * -r_g[121]))
		m.addConstr(r_122 >= uc_g[122] * (3*NUMBER_OF_MINUTES * -r_g[122]))
		m.addConstr(r_222 >= uc_g[222] * (3*NUMBER_OF_MINUTES * -r_g[222]))
		m.addConstr(r_322 >= uc_g[322] * (3*NUMBER_OF_MINUTES * -r_g[322]))
		m.addConstr(r_422 >= uc_g[422] * (3*NUMBER_OF_MINUTES * -r_g[422]))
		m.addConstr(r_522 >= uc_g[522] * (3*NUMBER_OF_MINUTES * -r_g[522]))
		m.addConstr(r_622 >= uc_g[622] * (3*NUMBER_OF_MINUTES * -r_g[622]))
		m.addConstr(r_123 >= uc_g[123] * (3*NUMBER_OF_MINUTES * -r_g[123]))
		m.addConstr(r_223 >= uc_g[223] * (3*NUMBER_OF_MINUTES * -r_g[223]))
		m.addConstr(r_323 >= uc_g[323] * (3*NUMBER_OF_MINUTES * -r_g[323]))
		...
		m.addConstr(r_302 <= uc_g[302] * (3*NUMBER_OF_MINUTES * r_g[302]))
		m.addConstr(r_402 <= uc_g[402] * (3*NUMBER_OF_MINUTES * r_g[402]))
		m.addConstr(r_107 <= uc_g[107] * (3*NUMBER_OF_MINUTES * r_g[107]))
		m.addConstr(r_207 <= uc_g[207] * (3*NUMBER_OF_MINUTES * r_g[207]))
		m.addConstr(r_307 <= uc_g[307] * (3*NUMBER_OF_MINUTES * r_g[307]))
		m.addConstr(r_113 <= uc_g[113] * (3*NUMBER_OF_MINUTES * r_g[113]))
		m.addConstr(r_213 <= uc_g[213] * (3*NUMBER_OF_MINUTES * r_g[213]))
