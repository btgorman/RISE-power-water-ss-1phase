...
def contingency_response(object_load, object_generator, object_cable, losses, exports):
	...
	try:
		...
		slack = m.addVar(lb=0.0, vtype=GRB.CONTINUOUS, name='slack')
		...
		m.addConstr(uc_g[101]*P_g[101] + r_101 >= uc_101*P_g_min[101])
		m.addConstr(uc_g[201]*P_g[201] + r_201 >= uc_201*P_g_min[201])
		m.addConstr(P_g[301] + r_301 >= P_g_min[301])
		m.addConstr(P_g[401] + r_401 >= P_g_min[401])
		m.addConstr(uc_g[102]*P_g[102] + r_102 >= uc_102*P_g_min[102])
		m.addConstr(uc_g[202]*P_g[202] + r_202 >= uc_202*P_g_min[202])
		m.addConstr(P_g[302] + r_302 >= P_g_min[302])
		m.addConstr(P_g[402] + r_402 >= P_g_min[402])
		m.addConstr(P_g[107] + r_107 >= P_g_min[107])
		m.addConstr(P_g[207] + r_207 >= P_g_min[207])
		m.addConstr(P_g[307] + r_307 >= P_g_min[307])
		m.addConstr(P_g[113] + r_113 >= P_g_min[113])
		m.addConstr(P_g[213] + r_213 >= P_g_min[213])
		m.addConstr(P_g[313] + r_313 >= P_g_min[313])
		m.addConstr(P_g[115] + r_115 >= P_g_min[115])
		m.addConstr(P_g[215] + r_215 >= P_g_min[215])
		m.addConstr(P_g[315] + r_315 >= P_g_min[315])
		m.addConstr(P_g[415] + r_415 >= P_g_min[415])
		m.addConstr(P_g[515] + r_515 >= P_g_min[515])
		m.addConstr(P_g[615] + r_615 >= P_g_min[615])
		m.addConstr(P_g[116] + r_116 >= P_g_min[116])
		m.addConstr(P_g[118] + r_118 >= P_g_min[118])
		m.addConstr(P_g[121] + r_121 >= P_g_min[121])
		m.addConstr(P_g[122] + r_122 >= P_g_min[122])
		m.addConstr(P_g[222] + r_222 >= P_g_min[222])
		m.addConstr(P_g[322] + r_322 >= P_g_min[322])
		m.addConstr(P_g[422] + r_422 >= P_g_min[422])
		m.addConstr(P_g[522] + r_522 >= P_g_min[522])
		m.addConstr(P_g[622] + r_622 >= P_g_min[622])
		m.addConstr(P_g[123] + r_123 >= P_g_min[123])
		m.addConstr(P_g[223] + r_223 >= P_g_min[223])
		m.addConstr(P_g[323] + r_323 >= P_g_min[323])

		# # Re-dispatch must be less than maximum generation ************************************************************************
		m.addConstr(uc_g[101]*P_g[101] + r_101 <= uc_101*P_g_max[101])
		m.addConstr(uc_g[201]*P_g[201] + r_201 <= uc_201*P_g_max[201])
		m.addConstr(P_g[301] + r_301 <= P_g_max[301])
		m.addConstr(P_g[401] + r_401 <= P_g_max[401])
		m.addConstr(uc_g[102]*P_g[102] + r_102 <= uc_102*P_g_max[102])
		m.addConstr(uc_g[202]*P_g[202] + r_202 <= uc_202*P_g_max[202])
		m.addConstr(P_g[302] + r_302 <= P_g_max[302])
		m.addConstr(P_g[402] + r_402 <= P_g_max[402])
		m.addConstr(P_g[107] + r_107 <= P_g_max[107])
		m.addConstr(P_g[207] + r_207 <= P_g_max[207])
		m.addConstr(P_g[307] + r_307 <= P_g_max[307])
		m.addConstr(P_g[113] + r_113 <= P_g_max[113])
		m.addConstr(P_g[213] + r_213 <= P_g_max[213])
		m.addConstr(P_g[313] + r_313 <= P_g_max[313])
		m.addConstr(P_g[115] + r_115 <= P_g_max[115])
		m.addConstr(P_g[215] + r_215 <= P_g_max[215])
		m.addConstr(P_g[315] + r_315 <= P_g_max[315])
		m.addConstr(P_g[415] + r_415 <= P_g_max[415])
		m.addConstr(P_g[515] + r_515 <= P_g_max[515])
		m.addConstr(P_g[615] + r_615 <= P_g_max[615])
		m.addConstr(P_g[116] + r_116 <= P_g_max[116])
		m.addConstr(P_g[118] + r_118 <= P_g_max[118])
		m.addConstr(P_g[121] + r_121 <= P_g_max[121])
		m.addConstr(P_g[122] + r_122 <= P_g_max[122])
		m.addConstr(P_g[222] + r_222 <= P_g_max[222])
		m.addConstr(P_g[322] + r_322 <= P_g_max[322])
		m.addConstr(P_g[422] + r_422 <= P_g_max[422])
		m.addConstr(P_g[522] + r_522 <= P_g_max[522])
		m.addConstr(P_g[622] + r_622 <= P_g_max[622])
		m.addConstr(P_g[123] + r_123 <= P_g_max[123])
		m.addConstr(P_g[223] + r_223 <= P_g_max[223])
		m.addConstr(P_g[323] + r_323 <= P_g_max[323])
		...
		for row in object_generator.matrix:
			if row[ODC.Generator.ID] == 101.0 or row[ODC.Generator.ID] == 201.0 or row[ODC.Generator.ID] == 102.0 or row[ODC.Generator.ID] == 202.0:
				row[ODC.Generator.OPERATIONAL_STATUS] = unit_recommit[int(row[ODC.Generator.ID])]
			...
			print(unit_response[int(row[ODC.Generator.ID])])
