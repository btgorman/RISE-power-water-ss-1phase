...
def unit_commitment_priority_list(object_load, object_generator, losses, exports):
	...
	try:
		...
		for row in object_generator.matrix:
			if row[ODC.Generator.ID] in [101.0, 102.0, 201.0, 202.0]:
				out_u_r[row[ODC.Generator.ID]] = min(row[ODC.Generator.REAL_GENERATION_MAX_RATING]-row[ODC.Generator.REAL_GENERATION], NUMBER_OF_MINUTES*row[ODC.Generator.RAMP_RATE])
			else:
				out_u_r[row[ODC.Generator.ID]] = row[ODC.Generator.OPERATIONAL_STATUS]*min(row[ODC.Generator.REAL_GENERATION_MAX_RATING]-row[ODC.Generator.REAL_GENERATION], NUMBER_OF_MINUTES*row[ODC.Generator.RAMP_RATE])
...
def unit_commitment_priority_list_n2(object_load, object_generator, losses, exports):
	...
	try:
		...
		# Minimum reserves for CAISO
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * (0.05*unit_dispatch.prod(hydro_coeff)) + (0.07*unit_dispatch.prod(non_hydro_coeff)))

		# Minimum reserves for largest dispatch+reserve unit
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[101.0]*unit_dispatch[101.0] + unit_reserves[101.0] + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0])))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[201.0]*unit_dispatch[201.0] + unit_reserves[201.0] + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0])))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[301.0] * (unit_dispatch[301.0] + unit_reserves[301.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[401.0] * (unit_dispatch[401.0] + unit_reserves[401.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[102.0]*unit_dispatch[102.0] + unit_reserves[102.0] + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0])))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[202.0]*unit_dispatch[202.0] + unit_reserves[202.0] + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0])))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[302.0] * (unit_dispatch[302.0] + unit_reserves[302.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[402.0] * (unit_dispatch[402.0] + unit_reserves[402.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[107.0] * (unit_dispatch[107.0] + unit_reserves[107.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[207.0] * (unit_dispatch[207.0] + unit_reserves[207.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[307.0] * (unit_dispatch[307.0] + unit_reserves[307.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[113.0] * (unit_dispatch[113.0] + unit_reserves[113.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[213.0] * (unit_dispatch[213.0] + unit_reserves[213.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[313.0] * (unit_dispatch[313.0] + unit_reserves[313.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[115.0] * (unit_dispatch[115.0] + unit_reserves[115.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[215.0] * (unit_dispatch[215.0] + unit_reserves[215.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[315.0] * (unit_dispatch[315.0] + unit_reserves[315.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[415.0] * (unit_dispatch[415.0] + unit_reserves[415.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[515.0] * (unit_dispatch[515.0] + unit_reserves[515.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[615.0] * (unit_dispatch[615.0] + unit_reserves[615.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[116.0] * (unit_dispatch[116.0] + unit_reserves[116.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[121.0] * (unit_dispatch[121.0] + unit_reserves[121.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[122.0] * (unit_dispatch[122.0] + unit_reserves[122.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[222.0] * (unit_dispatch[222.0] + unit_reserves[222.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[322.0] * (unit_dispatch[322.0] + unit_reserves[322.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[422.0] * (unit_dispatch[422.0] + unit_reserves[422.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[522.0] * (unit_dispatch[522.0] + unit_reserves[522.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[622.0] * (unit_dispatch[622.0] + unit_reserves[622.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[123.0] * (unit_dispatch[123.0] + unit_reserves[123.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[223.0] * (unit_dispatch[223.0] + unit_reserves[223.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[323.0] * (unit_dispatch[323.0] + unit_reserves[323.0]) + unit_commit[118.0] * (unit_dispatch[118.0]+unit_reserves[118.0]) ))

		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[101.0]*unit_dispatch[101.0] + unit_reserves[101.0] + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0])))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[201.0]*unit_dispatch[201.0] + unit_reserves[201.0] + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0])))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[301.0] * (unit_dispatch[301.0] + unit_reserves[301.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[401.0] * (unit_dispatch[401.0] + unit_reserves[401.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[102.0]*unit_dispatch[102.0] + unit_reserves[102.0] + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0])))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[202.0]*unit_dispatch[202.0] + unit_reserves[202.0] + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0])))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[302.0] * (unit_dispatch[302.0] + unit_reserves[302.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[402.0] * (unit_dispatch[402.0] + unit_reserves[402.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[107.0] * (unit_dispatch[107.0] + unit_reserves[107.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[207.0] * (unit_dispatch[207.0] + unit_reserves[207.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[307.0] * (unit_dispatch[307.0] + unit_reserves[307.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[113.0] * (unit_dispatch[113.0] + unit_reserves[113.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[213.0] * (unit_dispatch[213.0] + unit_reserves[213.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[313.0] * (unit_dispatch[313.0] + unit_reserves[313.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[115.0] * (unit_dispatch[115.0] + unit_reserves[115.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[215.0] * (unit_dispatch[215.0] + unit_reserves[215.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[315.0] * (unit_dispatch[315.0] + unit_reserves[315.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[415.0] * (unit_dispatch[415.0] + unit_reserves[415.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[515.0] * (unit_dispatch[515.0] + unit_reserves[515.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[615.0] * (unit_dispatch[615.0] + unit_reserves[615.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[116.0] * (unit_dispatch[116.0] + unit_reserves[116.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[118.0] * (unit_dispatch[118.0] + unit_reserves[118.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[122.0] * (unit_dispatch[122.0] + unit_reserves[122.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[222.0] * (unit_dispatch[222.0] + unit_reserves[222.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[322.0] * (unit_dispatch[322.0] + unit_reserves[322.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[422.0] * (unit_dispatch[422.0] + unit_reserves[422.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[522.0] * (unit_dispatch[522.0] + unit_reserves[522.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[622.0] * (unit_dispatch[622.0] + unit_reserves[622.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[123.0] * (unit_dispatch[123.0] + unit_reserves[123.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[223.0] * (unit_dispatch[223.0] + unit_reserves[223.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[323.0] * (unit_dispatch[323.0] + unit_reserves[323.0]) + unit_commit[121.0] * (unit_dispatch[121.0]+unit_reserves[121.0]) ))

		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[101.0]*unit_dispatch[101.0] + unit_reserves[101.0] + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0])))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[201.0]*unit_dispatch[201.0] + unit_reserves[201.0] + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0])))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[301.0] * (unit_dispatch[301.0] + unit_reserves[301.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[401.0] * (unit_dispatch[401.0] + unit_reserves[401.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[102.0]*unit_dispatch[102.0] + unit_reserves[102.0] + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0])))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[202.0]*unit_dispatch[202.0] + unit_reserves[202.0] + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0])))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[302.0] * (unit_dispatch[302.0] + unit_reserves[302.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[402.0] * (unit_dispatch[402.0] + unit_reserves[402.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[107.0] * (unit_dispatch[107.0] + unit_reserves[107.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[207.0] * (unit_dispatch[207.0] + unit_reserves[207.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[307.0] * (unit_dispatch[307.0] + unit_reserves[307.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[113.0] * (unit_dispatch[113.0] + unit_reserves[113.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[213.0] * (unit_dispatch[213.0] + unit_reserves[213.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[313.0] * (unit_dispatch[313.0] + unit_reserves[313.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[115.0] * (unit_dispatch[115.0] + unit_reserves[115.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[215.0] * (unit_dispatch[215.0] + unit_reserves[215.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[315.0] * (unit_dispatch[315.0] + unit_reserves[315.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[415.0] * (unit_dispatch[415.0] + unit_reserves[415.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[515.0] * (unit_dispatch[515.0] + unit_reserves[515.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[615.0] * (unit_dispatch[615.0] + unit_reserves[615.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[116.0] * (unit_dispatch[116.0] + unit_reserves[116.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[118.0] * (unit_dispatch[118.0] + unit_reserves[118.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[121.0] * (unit_dispatch[121.0] + unit_reserves[121.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[122.0] * (unit_dispatch[122.0] + unit_reserves[122.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[222.0] * (unit_dispatch[222.0] + unit_reserves[222.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[322.0] * (unit_dispatch[322.0] + unit_reserves[322.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[422.0] * (unit_dispatch[422.0] + unit_reserves[422.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[522.0] * (unit_dispatch[522.0] + unit_reserves[522.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[622.0] * (unit_dispatch[622.0] + unit_reserves[622.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[123.0] * (unit_dispatch[123.0] + unit_reserves[123.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
		m.addConstr(unit_reserves.sum() >= EXTRA_RESERVE_MARGIN_n2 * ( unit_commit[223.0] * (unit_dispatch[223.0] + unit_reserves[223.0]) + unit_commit[323.0] * (unit_dispatch[323.0]+unit_reserves[323.0]) ))
...
def unit_commitment_priority_list_2_n2(object_load, object_generator, losses, exports):
...
# def contingency_response_2(object_load, object_generator, object_cable):
...
# 		# Branches must be less than maximum thermal limit ************************************************************************
# 		# Branches must be greater than the minimum thermal limit *****************************************************************
...
# 	except gurobipy.GurobiError:
# 		print('Gurobi error reported in contingency response')
